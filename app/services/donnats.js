...
export const fetchAll = async () => {
  try {
    const response = await axios.get(`https://apds-backend.vercel.app/api/getDonations`);
...
export const create = async (partner) => {
  try {
    const response = await axios.post(`https://apds-backend.vercel.app/api/addDonation`, partner);
    return response;
  } catch (error) {
